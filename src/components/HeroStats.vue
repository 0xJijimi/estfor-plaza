        ...
        <div class="card-body">
            <div class="overflow-x-auto">
                <table class="table md:table-md table-xs">
                    ...
                    <tr>
                        <th class="w-20">
                            <button type="button" class="btn btn-primary btn-sm" @click.prevent="broochStore.brooch(0).balance === 0 ? emeraldBroochPaywallRef?.openDialog() : changeHeroStatsRef?.openDialog()">
